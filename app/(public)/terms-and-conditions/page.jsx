export default function TermsAndConditions() {
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 text-gray-800">
      ...
      <ul className="list-disc ml-6 mb-4">
        <li>
          Prices displayed on the website are inclusive or exclusive of taxes as
          applicable.
        </li>
        <li>
          Payments must be made using valid payment methods such as Credit/Debit
          Cards, UPI, Wallets, EMI, or Net Banking (subject to availability).
        </li>
        <li>
      ...
      <p className="mb-4">
        Nilaas reserves the right to update or modify these Terms & Conditions at
